...
<section class="bg-gray-200 px-3 lg:mx-auto mt-16 lg:mt-44">
	<div class="container mx-auto text-center lg:text-left lg:flex lg:justify-between items-center py-8">
		<div class="text-xl font-bold uppercase tracking-wide mb-3 lg:mb-0">Kementerian</div>
		<div class="text-sm text-gray-500 tracking-wide">
			<a href="#">Home</a> / <a href="javascript:void(0)" class="font-semibold">Kementerian</a>
		</div>
	</div>
</section>
...
<section class="container px-3 py-8 lg:mx-auto"> 
	<div class="grid grid-cols-2 gap-6 lg:gap-0 lg:grid-cols-4 justify-center items-center">
		<div class="text-center">
			<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-people-fill h-12 lg:h-24 text-black mx-auto mb-5" viewBox="0 0 16 16"><path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"/><path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/></svg>
			<div class="text-blue-400 text-5xl lg:text-6xl font-bold mb-3 uppercase">8465</div>
			<div class="text-gray-400 text-xs lg:text-xl font-regular mb-5 uppercase">Clients Served</div>
		</div>
		<div class="text-center">
			<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-code-slash h-12 lg:h-24 text-black mx-auto mb-5" viewBox="0 0 16 16"><path d="M10.478 1.647a.5.5 0 1 0-.956-.294l-4 13a.5.5 0 0 0 .956.294l4-13zM4.854 4.146a.5.5 0 0 1 0 .708L1.707 8l3.147 3.146a.5.5 0 0 1-.708.708l-3.5-3.5a.5.5 0 0 1 0-.708l3.5-3.5a.5.5 0 0 1 .708 0zm6.292 0a.5.5 0 0 0 0 .708L14.293 8l-3.147 3.146a.5.5 0 0 0 .708.708l3.5-3.5a.5.5 0 0 0 0-.708l-3.5-3.5a.5.5 0 0 0-.708 0z"/></svg>
			<div class="text-red-400 text-5xl lg:text-6xl font-bold mb-3 uppercase">56841</div>
			<div class="text-gray-400 text-xs lg:text-xl font-regular mb-5 uppercase">Lines Of Code</div>
		</div>
		<div class="text-center">
			<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-briefcase-fill h-12 lg:h-24 text-black mx-auto mb-5" viewBox="0 0 16 16"><path d="M6.5 1A1.5 1.5 0 0 0 5 2.5V3H1.5A1.5 1.5 0 0 0 0 4.5v1.384l7.614 2.03a1.5 1.5 0 0 0 .772 0L16 5.884V4.5A1.5 1.5 0 0 0 14.5 3H11v-.5A1.5 1.5 0 0 0 9.5 1h-3zm0 1h3a.5.5 0 0 1 .5.5V3H6v-.5a.5.5 0 0 1 .5-.5z"/><path d="M0 12.5A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5V6.85L8.129 8.947a.5.5 0 0 1-.258 0L0 6.85v5.65z"/></svg>
			<div class="text-green-400 text-5xl lg:text-6xl font-bold mb-3 uppercase">2154</div>
			<div class="text-gray-400 text-xs lg:text-xl font-regular mb-5 uppercase">No. Of Projects</div>
		</div>
		<div class="text-center">
			<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-cup-straw h-12 lg:h-24 text-black mx-auto mb-5" viewBox="0 0 16 16"><path d="M13.902.334a.5.5 0 0 1-.28.65l-2.254.902-.4 1.927c.376.095.715.215.972.367.228.135.56.396.56.82 0 .046-.004.09-.011.132l-.962 9.068a1.28 1.28 0 0 1-.524.93c-.488.34-1.494.87-3.01.87-1.516 0-2.522-.53-3.01-.87a1.28 1.28 0 0 1-.524-.93L3.51 5.132A.78.78 0 0 1 3.5 5c0-.424.332-.685.56-.82.262-.154.607-.276.99-.372C5.824 3.614 6.867 3.5 8 3.5c.712 0 1.389.045 1.985.127l.464-2.215a.5.5 0 0 1 .303-.356l2.5-1a.5.5 0 0 1 .65.278zM9.768 4.607A13.991 13.991 0 0 0 8 4.5c-1.076 0-2.033.11-2.707.278A3.284 3.284 0 0 0 4.645 5c.146.073.362.15.648.222C5.967 5.39 6.924 5.5 8 5.5c.571 0 1.109-.03 1.588-.085l.18-.808zm.292 1.756C9.445 6.45 8.742 6.5 8 6.5c-1.133 0-2.176-.114-2.95-.308a5.514 5.514 0 0 1-.435-.127l.838 8.03c.013.121.06.186.102.215.357.249 1.168.69 2.438.69 1.27 0 2.081-.441 2.438-.69.042-.029.09-.094.102-.215l.852-8.03a5.517 5.517 0 0 1-.435.127 8.88 8.88 0 0 1-.89.17zM4.467 4.884s.003.002.005.006l-.005-.006zm7.066 0-.005.006c.002-.004.005-.006.005-.006zM11.354 5a3.174 3.174 0 0 0-.604-.21l-.099.445.055-.013c.286-.072.502-.149.648-.222z"/></svg>
			<div class="text-purple-400 text-5xl lg:text-6xl font-bold mb-3 uppercase">874</div>
			<div class="text-gray-400 text-xs lg:text-xl font-regular mb-5 uppercase">Cups Of Drink</div>
		</div>
	</div>
</section>
