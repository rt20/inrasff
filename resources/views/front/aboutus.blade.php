...
<section class="container px-3 py-12 lg:mx-auto">
	<div class="text-xl font-bold mb-5">Indonesia Rapid Alert System For Food And Feed</div>
			...
			<div x-show="show" class="border-b text-sm lg:text-base border-gray-200 pb-4 leading-normal">
				...
				<ul class="mb-5 list-decimal list-inside space-y-3 mb-8">
					...
					<li>
						...
						<table class="table-auto border-collapse border my-8 hidden lg:block">
							<thead>
								<tr class="text-center bg-gray-500">
									<th class="border">2010</th>
									<th class="border">2011</th>
									<th class="border">2012</th>
									<th class="border">2013</th>
									<th class="border">2014</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="border">1. Penguatan SKPKP di Badan POM RI</td>
									<td class="border">1. Pemetaan Tugas dan Fungsi antar instansi terkait RASFF</td>
									<td rowspan="3" class="border">1. Aplikasi sistem National RASFF di Indonesia</td>
									<td rowspan="3" class="border">1. Revisi dan perbaikan aplikasi sistem nasional RASFF di Indonesia</td>
									<td rowspan="3" class="border">Indonesia berperan serta dalam ASEAN RAPID ALERT SYSTEM FOR FOOD AND FEED</td>
								</tr>
								<tr>
									<td class="border">2. Inisiasi pertemuan2 dengan lintas sektor terkait untuk membicarakan mengenai NATIONAL RASFF</td>
									<td class="border">2. Tata cara dan alur yang jelas untuk pelaporan dan pertukaran informasi</td>
								</tr>
								<tr>
									<td class="border">3. Pembuatan  rancangan TOR NATIONAL RASFF</td>
									<td class="border">3. Peresmian TOR NATIONAL RASFF</td>
								</tr>
							</tbody>
						</table>
					</li>
		...
		<table class="table-auto border-collapse border my-8 leading-normal">
			<thead>
				<tr class="text-center bg-gray-200">
					<th class="border">Deskripsi Proyek</th>
					<th class="border">Indikator Kinerja</th>
					<th class="border">Alat Verifikasi</th>
					<th class="border">Asumsi</th>
				</tr>
			</thead>
			<tbody>
				<tr>
