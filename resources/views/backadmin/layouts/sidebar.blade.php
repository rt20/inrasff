    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ Str::startsWith(Route::currentRouteName(), 'backadmin.categories') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('backadmin.categories.index') }}"><i data-feather="book"></i><span class="menu-title text-truncate" data-i18n="Kategori Berita">Kategori Berita</span></a>
            </li>
            @endcan
