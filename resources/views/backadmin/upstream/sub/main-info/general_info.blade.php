...
<div class="row">
    ...
    <div class="col-12 col-md-6 form-group">
        ...
        <select 
            ...
            v-model="upstream.status_notif_id" 
    ...
    <div class="col-12 col-md-6 form-group">
        ...
        <select 
            id="f_type_notif_id"
            v-model="upstream.type_notif_id" 
    ...
    <div class="col-12 col-md-6 form-group">
        ...
        <select 
            id="f_based_notif_id"
            v-model="upstream.based_notif_id" 
            name="based_notif_id" 
    ...
    <div class="col-12 col-md-6 form-group">
        ...
        <div v-show="upstream.origin_source_notif === '' ">
            <input class="form-control" disabled value="Silahkan pilih sumber asal notifikasi terlebih dahulu">
        </div>
        <div v-show="upstream.origin_source_notif === 'local' ">
            <select 
                v-cloak
                v-model="upstream.source_notif" 
                :disabled="upstream.origin_source_notif !== 'local'" 
                name="source_notif" 
        ...
        <div v-show="upstream.origin_source_notif === 'interlocal' ">
            <select 
                v-cloak
                v-model="upstream.source_notif" 
                :disabled="upstream.origin_source_notif !== 'interlocal'"
                name="source_notif" 
                class="form-control select2 @error('source_notif') {{ 'is-invalid' }} @enderror">
    ...
    <div class="col-12 col-md-6 form-group">
        ...
        <input type="text" 
            name="date_notif"
            v-model="upstream.date_notif" 
            class="form-control date {{ in_array($upstream->status, ['draft', 'open']) ? 'read-only-white' : ''}} @error('date_notif') {{ 'is-invalid' }} @enderror" 
...
{{--     
    <div class="col-12 col-md-12 form-group">
        ...
        <div v-cloak v-if="upstream.id === ''" class="demo-spacing-0">
            <div class="alert alert-warning" role="alert">
                <div class="alert-body"><strong>Silahkan simpan terlebih dahulu upstream ini untuk menambahkan instansi</strong></div>
            </div>
        </div>
